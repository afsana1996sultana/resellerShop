            ...
            <div class="col-sm-4">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="mb-3">
                            <form action="">
                                <input class="form-control barcode_product_add" type="text" name="barcode_product_add" id="barcode_product_add" placeholder="Add by Barcode">
                            </form>
                        </div>
                        <form action="{{ route('pos.store') }}" method="POST" target="_blank" id="myForm">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="reloadButton" style="float: right;"><span><i class="fas fa-money-check-alt"></i></span> Place Order </button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-1">
                                    ...
                                    <input type="text" placeholder="Write Phone" id="phone" name="phone" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-1">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-1">
                                    ...
                                    <input type="text" placeholder="Write Address" id="address" name="address" class="form-control">
                                </div>
                            </div>
                            <div class="mb-1 mt-2">
...
@push('footer-script')
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            document.getElementById('barcode_product_add').focus();
        });
