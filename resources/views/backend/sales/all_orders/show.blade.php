                        ...
                        <article class="icontext align-items-start">
                            ...
                            <div class="text">
                                ...
                                <p class="mb-1">
                                    ...
                                    Shipping: {{ $order->shipping_name ?? 'No Shipping' }} <br />
                            ...
                            <form action="{{ route('admin.orders.update', $order->id) }}" method="post">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label for="upazilla_id" class="fw-bold text-black"><span class="text-danger">*</span> Address</label>
                ...
                <form method="post" action="{{ route('admin.user.update', $order->id) }}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <label for="division_id" class="fw-bold text-black col-form-label">Email</label>
                                <input type="text" class="form-control" name="email" placeholder="Enter the email"
                                    value="{{ $order->email ?? '' }}">
                            </div>
                            <div class="form-group col-lg-12">
                                <label for="division_id" class="fw-bold text-black col-form-label">Phone</label>
