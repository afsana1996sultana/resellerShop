    ...
    <tr class="cart__product">
        ...
        <td style="width: 30%;" >
            ...
            <div class="input-group quantity__btn__change">
                ...
                <!-- quantity input -->
                    <input class="form-control text-center quantity_input quantity__number" value="{{ $cart->quantity }}" min="1" max="" type="text" name="quantity" disabled>
                     <!--<input class="form-control text-center quantity_input quantity__number" value="{{ $cart->quantity }}" min="1" max="" type="text" name="quantity">-->
                <!-- incress -->
