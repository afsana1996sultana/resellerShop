...
class AdminController extends Controller
{
    ...
    /*=================== Start Dashboard Methoed ===================*/
       public function Dashboard(){
        ...
        $todays_sale  = Order::whereDay('created_at', '=', date('d'))->get();
        $todays_sale_value  = Order::whereDay('created_at', date('d'))->sum('sub_total');
        ...
        $todays_purchase_value  = Product::whereDay('created_at', date('d'))->sum('purchase_price');
        $monthly_purchase  = Product::whereMonth('created_at', $currentMonth)->count();
        $monthly_purchase_value  = Product::whereMonth('created_at', $currentMonth)->sum('purchase_price');
        $yearly_purchase  = Product::whereYear('created_at', date('Y-m-d'))->count();
        $yearly_purchase_value  = Product::whereYear('created_at', date('Y-m-d'))->sum('purchase_price');
